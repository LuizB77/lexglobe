    ...
    <div className="min-h-screen pt-14 flex items-center justify-center px-4"
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">LexGlobe</h1>
          ...
          <div className="flex flex-col gap-3 mb-6">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4
                ...
                hover:bg-gray-900 transition-colors min-h-[44px]"
            >
            ...
            {mode === 'signup' && (
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200
                  ...
                  focus:outline-none focus:border-gray-400 min-h-[44px]"
              />
            )}
            <input
              type="email"
        ...
        <button
          onClick={() => navigate('/')}
          className="w-full text-center text-xs text-gray-400 mt-4
